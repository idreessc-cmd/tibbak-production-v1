...
import { Calendar, Clock, User, Phone, CheckCircle, FileText } from 'lucide-react';

interface BookingWidgetProps {
  hospitalId: string;
}

export default function HospitalBookingWidget({ hospitalId }: BookingWidgetProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
      <h3 className="text-base font-bold text-slate-800 flex items-center gap-2 mb-4">
        ...
        {isRtl ? 'حجز موعد زيارة أو كشف مستشفى' : 'Book Visit or Hospital Consultation'}
      </h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={isRtl ? 'أدخل القسم أو الطبيب المفضل أو تفاصيل إضافية...' : 'Enter preferred department, doctor, or details...'}
